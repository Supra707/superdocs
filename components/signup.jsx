    ...
    <div>
      ...
      <form class="max-w-sm mx-auto">
        ...
        {loading ? (
          ...
          <Button variant="shadow" className="w-full bg-blue-700 text-white text-md font-bold" onClick={handleSubmit}>
            LogIn
          </Button>
        )}
        ...
        <div className="flex flex-col gap-y-5 justify-center items-center">
          <button
            ...
            type="button"
            className="w-full justify-center gap-x-3 flex items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
            <span>
              <Image
